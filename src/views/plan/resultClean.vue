...
import { minipCleaningCheckListCommitGet } from '@/api/task'
  ...
  methods: {
    ...
    toReport () {
      ...
      this.$router.push({
        ...
        query: {
          source: source, commitId: this.commitId, pointId: this.pointId, taskId: this.taskId, type: WorkOrderType.clean, groupId: this.commitDetail.belong_group_id
        }
      })
    }
  }

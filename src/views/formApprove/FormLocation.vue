<template>
  <FormLocationView v-if="formReadonly(opt)" :model="model" :opt="opt" />
  <div v-else>
    <van-field
      v-model="selAddress"
      clickable
...
import FormLocationView from './detail/FormTextView'

// todo current默认选中当前用户
export default {
  name: 'FormLocation',
  components: { indexBar, FormLocationView },
  mixins: [mixin],
  props: {
    model: {
      type: Object,
